...
int main()
{
    ...
    instruction = Fetch(); //applying contents of the instruction onto this variable

    printf("%d\n", instruction); //to test if instruction gets the correct value
...
char Fetch(){
    ...
    char instruction[32]; //to carry the new 32 bit instruction
